...
<body>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="page-breadcrumb">
                        <h2>Avis Sur Produit<span>.</span></h2>
                    </div>
                </div>
                <div class="col-lg-8">
    ...
    <div class="contact-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <form action="processaddavis.jsp" method="post" class="contact-form">
                        <div class="row">
                            <div class="col-lg-12">
                                      <label >Produit </label>
                ...
                <div class="rating"> <input type="radio" name="rating" value="5" id="5"><label for="5" style=" border-color: #f50202">☆</label> <input type="radio" name="rating" value="4" id="4"><label for="4">☆</label> <input type="radio" name="rating" value="3" id="3"><label for="3">☆</label> <input type="radio" name="rating" value="2" id="2"><label for="2">☆</label> <input type="radio" name="rating" value="1" id="1"><label for="1">☆</label> </div>
                            ...
                            <div class="col-lg-12">
                              <label >Commentaire </label>
                                  ...
                                  <textarea name="nm" placeholder="Commentaire"></textarea>
                            </div>
                            <div class="col-lg-12 text-right">
                                <button type="submit">Envoyer Rate</button>
                            </div>
                        </div>
                    </form>
                </div>

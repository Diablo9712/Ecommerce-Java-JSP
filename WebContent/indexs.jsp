    ...
    <div class="row">
        <div class="col-12 col-sm-3">
            <div class="card bg-light mb-3">
                <div class="card-header bg-primary text-white text-uppercase"><i class="fa fa-list"></i> Categories</div>
                     ...
                     <li class="list-group-item"><a href="indexs.jsp?cat=<%=rest.getString("id") %>"><%=rest.getString("libelle") %></a></li>
                            <%
 			 		}
 			 		%>
                           </ul>
        ...
        <div class="col">
            <div class="row">
 			 		...
 			 		if(query !=null){
 			 			data = "select * from `produit` where id_cat = "+query;
						//	out.println(query);
 			 		}
 			 		else{
 			 		...
 			 		%>
                           ...
                           <div class="col-12 col-md-6 col-lg-4" style="margin-left:20px;margin-bottom:30px">
                    <div class="card" style="width:300px;margin-left:50px">
                        <img class="card-img-top" src="img/<%= res.getString("image") %>" style="height:150px" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title"><a href="product.html" title="View Product"><%= res.getString("libelle") %></a></h4>
                            <p class="card-text"><%= res.getString("description") %></p>
                            <div class="row">
                                <div class="col">
                                    <p class="btn btn-danger btn-block" style="width:100px"><%= res.getString("prix") %> DH</p>
                                </div>
                                <div class="col">
                                    <a href="login.jsp" style="width:100px" class="btn btn-success btn-block">Acheter</a>
                                </div>
                            </div>
                        </div>
                    </div>

 ...
 <span class="flaticon-shopping-cart"><% out.println(nombre); %>
    ...
    <section class="product-page">
                    <%  String host = "jdbc:mysql://localhost:3306/ecommerce";
 			 		...
 			 		String id = request.getParameter("ww");
 			 		Class.forName("com.mysql.jdbc.Driver");
 			 		...
 			 		System.out.println(commande+" "+id);
 			 			...
 			 			data = "select distinct produit.id,produit.libelle as produit,produit.description,produit.prix,produit.image,categorie.libelle as cat from produit,categorie,avis WHERE   categorie.id = produit.id_cat and produit.id =  "+id;
						//	out.println(query);
 			 	
 			 		res = stat.executeQuery(data);
 			 		while(res.next()){
 			 			
 			 			produit =res.getString("produit");
 			 			desc = res.getString("description");
 			 			prix = res.getString("prix");
 			 			cat = res.getString("cat");
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="product-content">
                       ...
                       <input type="hidden" name="ww" value="<%=id %>">
                        <input type="hidden" name="vvv" value="<%=commande %>">
